...
public class RedEnvelopeUtil {
	/** 过期时间 */
	private static long INTERVAL_TIME = 3*24*60*60*1000;
	/** 存取证书 */
	...
	/** 普通红包 */
	public static final String COMM_RED_ENVELOPE = "https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack";
	/** 分裂红包 */
	public static final String GROUP_RED_ENVELOPE = "https://api.mch.weixin.qq.com/mmpaymkttransfers/sendgroupredpack";
