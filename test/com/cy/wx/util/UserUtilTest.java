...
public class UserUtilTest {
	...
	public void testGetTag() {
		...
		System.out.println(JSONArray.fromObject(userTagList).toString());
	}
	...
	public void testGetUserInfo() {
		...
		for(String openId : weixinUserList.getOpenIdList()){
			...
			//System.out.println(JSONObject.fromObject(wui).toString());
			//break;
		}
	}
	...
	public void testGetUserInfo2() {
		String openId = "oR8rRvteSocpyAMs3n4f7UbRYQy8";
		WeixinUserInfo wui = UserUtil.getUserInfo(InitUtil.accessToken, openId, "");
		System.out.println(JSONObject.fromObject(wui).toString());
	}
