...
import com.cy.wx.card.Card;
import com.cy.wx.card.CardQR;
import com.cy.wx.card.DateInfo;
import com.cy.wx.card.GrouponCard;
import com.cy.wx.card.Sku;
import com.cy.wx.model.WeixinAction;
...
public class CardUtilTest {
	...
	public void testCreateCard(){
		...
		String jsonData = JSONObject.fromObject(map2).toString();
	...
	public void testCreateCardQR(){
		...
		qr.setIs_unique_code(false);
		qr.setOuter_id(1);
		System.out.println(JSONObject.fromObject(qr, jsonConfig).toString());
		
		JSONObject action_info = new JSONObject();
		action_info.put("card", JSONObject.fromObject(qr, jsonConfig)); // 过滤
		...
		String jsonData = JSONObject.fromObject(action, jsonConfig).toString(); // 过滤
		System.out.println(jsonData); 
	...
	public void testGetCode(){
		...
		if(jsonObj != null){
			...
			if(errCode ==  0){
				...
				int beginTime = jsonObj2.getInt("begin_time");
				int endTime = jsonObj2.getInt("end_time");
			}
		}
	}
