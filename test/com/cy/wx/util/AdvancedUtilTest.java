...
import com.cy.wx.message.mass.MGFilter;
import com.cy.wx.message.mass.MGNewsMsg;
import com.cy.wx.message.mass.MNews;
import com.cy.wx.message.mass.MPNewsMsg;
import com.cy.wx.message.mass.MPVideoMsg;
import com.cy.wx.message.mass.MVideo;
...
public class AdvancedUtilTest {
	...
	public void testCreateCustomAccount() {
		...
		Assert.assertTrue(AdvancedUtil.createCustomAccount(InitUtil.accessToken, JSONObject.fromObject(ca, jsonConfig).toString()));
	}
	...
	public void testGetAllCustomAccount() {
		AdvancedUtil.getAllCustomAccount(InitUtil.accessToken);
	}

	@Test
	public void testMakeTextCustomMessage() {
		System.out.println(AdvancedUtil.makeTextCustomMessage(Constant.APPID, "test"));
	}
	...
	public void testGetGroups() {
		...
		System.out.println(JSONArray.fromObject(weixinGroupList).toString());
	}
	...
	public void testMassMsgByGroup() {
		...
		System.out.println(JSONObject.fromObject(mNewsMsg).toString());
...
//		AdvancedUtil.massMsgByOpenID(InitUtil.accessToken, JSONObject.fromObject(mpNewsMsg).toString());
		...
		AdvancedUtil.massMsgByOpenID(InitUtil.accessToken, JSONObject.fromObject(mpVideoMsg).toString());
	}
	...
	public void testMassMsgPreview() {
		...
		AdvancedUtil.massMsgPreview(InitUtil.accessToken, JSONObject.fromObject(mpNewsMsg).toString().replace("[", "").replace("]", ""));
	...
	public void testSendTemplateMsg() {
		...
		String jsonMsg = JSONObject.fromObject(wrapMap).toString();
