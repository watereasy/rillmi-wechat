...
import com.cy.wx.shake.req.AccountRegisterReq;
...
public class ShakeUtilTest {
	...
	public void testRegister() {
		...
		List<String> qualification_cert_urls = new ArrayList<String>();
		...
		String jsonMsg = JSONObject.fromObject(register).toString();
	...
	public void test01(){
		...
		UserGetShakeInfoResp shakeInfo = (UserGetShakeInfoResp)JSONObject.toBean(jsonObj, UserGetShakeInfoResp.class);
